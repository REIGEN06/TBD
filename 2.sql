...
--SELECT student_id, hobby_id FROM student_hobby WHERE started_at BETWEEN '2022-12-11'
--AND '2022-12-22' AND finished_at IS NULL;

--SELECT name, surname, score FROM student WHERE score > 3 ORDER BY score DESC;
...
/*SELECT n_group, AVG(score) AS avg_score 
FROM student GROUP BY n_group HAVING AVG(score) <= 4
...
/*SELECT n_group, id as id_stud, surname, score FROM student WHERE n_group = 2282 
